...
<el-row gutter="24">
  <el-card>
      <el-col :span="4">
      <el-select style="width:100%" v-model="form.pgrm_id" filterable placeholder="Program Code" @change="onSelectedPgrm($event, depts)">
          <el-option
          v-for="pgrm in pgrms"
          :key="pgrm._id"
          :label="pgrm.pgrm_code"
          :value="pgrm._id">
          </el-option>
      </el-select>
       <el-input v-model="form.pgrm_code" type="hidden"></el-input>
      </el-col>
...
<el-row gutter="20">
  ...
  <br><br>
       <el-card>
        <el-table @selection-change="selsChange" v-loading="listLoading"
          ref="multipleTable"
          :data="students.filter(student => !search || student.HKID.toLowerCase().includes(search.toLowerCase()))"
          tooltip-effect="dark"
          style="width: 100%">
          <el-table-column
            type="selection"
  ...
  <br><br><br>
    ...
    <div style='float:right'>
      <el-button type="primary" @click="activePrgm()">Create</el-button>
...
methods: {
    ...
    activePrgm(){
     ...
     let para= {
       ...
       class_dept:this.form.dept_name,
